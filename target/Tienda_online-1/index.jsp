    ...
    <body style="margin-top: 30px">      
        ...
        <div class="container"> 
            ...
            <div class="btn-group" role="group" aria-label="Basic example">
                <button type="button" class="btn btn-primary">Mauricio Cauna Larico</button>
                ...
                <button type="button" class="btn btn-primary">Tienda de productos</button>
            </div>
            </center>
            <br>
            <br>
            <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal">Nuevo Producto😃</button>
